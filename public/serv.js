...
var sensorController = require('./sensorControl');
...
// Filtering search parameters and adding them
...
app.get('/', function (request, response) { // default document
    console.log(sensorController.measurements);
